<?php
   ...
   ***************************************************/
  $accepted_origins = array("http://localhost", "http://192.168.1.1", "https://ajk.gov.pk");
  ...
  if (is_uploaded_file($temp['tmp_name'])){
    ...
    */
    ...
    @$file_ext=strtolower(end(explode('.',$temp['name'])));
    @$mimetype = mime_content_type($temp['tmp_name']);
    ...
    if(!empty($file_ext) && !empty($mimetype) && in_array($file_ext,$expensions) && in_array($mimetype,$mimes)) 
    {
